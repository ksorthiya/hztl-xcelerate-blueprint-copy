  ...
  return (
    <ul className={hamburgerBase()}>
      <li className={hamburgerItem()}>
        ...
        >
          <SvgIcon icon="magnifier" fill="none" size="s" viewBox="-4 -4 24 24" />
        </button>
      </li>
      <li className={hamburgerItem()}>
        <button
...
const TAILWIND_VARIANTS = tv({
  slots: {
    buttonItemIcon: [
      ...
      'transition-all',
      '!w-xs',
      'text-component-header-nav-bar-link-nav-link-icon',
      'group-hover:text-component-header-mega-menu-link-link-text',
      'group-focus:text-component-header-mega-menu-link-link-text',
      'fill-current',
    ],
    dropDownButton: [
      'cursor-pointer',
      ...
      'w-full',
      'group-hover:text-component-header-mega-menu-link-link-text-hover',
      'group-focus:text-component-header-mega-menu-link-link-text-hover',
    ...
    hamburgerItem: ['flex', 'items-center', 'justify-center', 'w-8'],
    hamburgerButton: [
      'hamburger-button',
      'h-8',
      'w-8',
      ...
      'duration-300',
      'text-component-header-nav-bar-link-nav-link-icon',
      'hover:text-component-header-nav-bar-link-nav-link-icon-hover',
      'focus-visible:outline-none',
      'focus-visible:ring-4',
      'focus-visible:ring-offset-1',
      'focus-visible:ring-offset-white/75',
  ...
  variants: {
    ...
    isRotated: {
      ...
      true: {
        buttonItemIcon: ['rotate-0', 'text-component-header-nav-bar-link-nav-link-icon-active'],
      },
    },
    isMainNav: {
      true: {
